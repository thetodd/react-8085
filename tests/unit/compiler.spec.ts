...
test('it should compile mvi r mnemonic group', () => {
    ...
    expect(assembly.sections[0].bytes[1]).toBe(0x0e)
    expect(assembly.sections[0].bytes[2]).toBe(0x16)
    expect(assembly.sections[0].bytes[3]).toBe(0x1e)
    expect(assembly.sections[0].bytes[4]).toBe(0x26)
    expect(assembly.sections[0].bytes[5]).toBe(0x2e)
    expect(assembly.sections[0].bytes[6]).toBe(0x36)
    expect(assembly.sections[0].bytes[7]).toBe(0x3e)
})